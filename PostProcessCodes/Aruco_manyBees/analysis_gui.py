...
class AnalysisWindow(QtWidgets.QWidget):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("Multi-Bee Tracking Data Analyzer")
        self.resize(760, 560)
    ...
    def _build_ui(self) -> None:
        ...
        self.lbl_info = QtWidgets.QLabel("Select a tracking output folder containing one *_info.txt file and matching raw/filtered coordinate files.")
        ...
        scaling_group = QtWidgets.QGroupBox("Custom Scaling")
        scaling_layout = QtWidgets.QVBoxLayout(scaling_group)
        self.chk_scale_by_id = QtWidgets.QCheckBox("Scale according to ID")
        scaling_layout.addWidget(self.chk_scale_by_id)

        id_layout = QtWidgets.QHBoxLayout()
        id_layout.addWidget(QtWidgets.QLabel("Select Reference ID:"))
        self.combo_scale_id = QtWidgets.QComboBox()
        self.combo_scale_id.setEnabled(False)
        id_layout.addWidget(self.combo_scale_id)
        id_layout.addStretch(1)
        scaling_layout.addLayout(id_layout)
        
        self.chk_scale_by_id.toggled.connect(self.combo_scale_id.setEnabled)
    ...
    def select_folder(self) -> None:
        ...
        self.btn_save_plots.setEnabled(False)
        self.btn_save_report.setEnabled(False)
        self.chk_scale_by_id.setChecked(False)
        self.combo_scale_id.clear()
    ...
    def run_analysis(self) -> None:
        ...
        try:
            ...
            self.bundle = analysis_core.build_analysis_bundle(
        ...
        self.combo_scale_id.clear()
        self.combo_scale_id.addItems(self.bundle.bee_ids)
    ...
    def save_plots(self) -> None:
        ...
        try:
            ...
            QtWidgets.QApplication.processEvents()
            scale_by_id = self.combo_scale_id.currentText() if self.chk_scale_by_id.isChecked() else None
            saved = analysis_core.create_static_plots(self.bundle, output_dir, scale_by_id=scale_by_id)
